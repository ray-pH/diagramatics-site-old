...
// /home/ray/Code/diagramatics/dist/vector.js
function V2(x, y) {
...
// /home/ray/Code/diagramatics/dist/html_interactivity.js
var format_number = function(val, prec) {
...
function subdivide(n = 100) {
  function func(d) {
    ...
    for (let i in d.path.points) {
      ...
      let subdivide_points = xs.map((x, i2) => V2(x, ys[i2]));
...
function vector7(v, str, text_offset, arrow_head_size) {
